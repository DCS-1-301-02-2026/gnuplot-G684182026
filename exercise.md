...
set xlabel "x"
set ylabel "y"
plot x / log(x) w l title "f2(x)", 2 * x**2 * sqrt(x) - 5 * x**2 w l title "f1(x)"
```
...
plot "weather2026.csv" using 1:2 title "最高気温" w l,"weather2026.csv" using 1:3 title "最高気温（平年）" w l,"weather2026.csv" using 1:4 title "最低気温" w l, "weather2026.csv" using 1:5 title "最低気温（平年）" w l,
```
